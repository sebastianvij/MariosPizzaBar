...
public class PizzaMenuList {
    ...
    static {
        ...
        pizzaList.add(new Pizza("Glizzy Pizza", 60, 13, new String[]{"Tomatsauce", "Ost", "Cocktailpølser"}));
        ...
        pizzaList.add(new Pizza("Pommes Frites Pizza", 79, 22, new String[]{"Tomatsauce", "Ost", "Pommes Frites", "Kebabkød", "Dressing"}));
